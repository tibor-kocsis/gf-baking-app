...
The app SHALL include pizza dough, sandwich bread, waffles, baguette, American pancakes, and cheese sticks as the initial recipes.
...
#### Scenario: Baguette recipe available
- **WHEN** the user views the recipe catalog
- **THEN** "Baguette" is listed as an available recipe
